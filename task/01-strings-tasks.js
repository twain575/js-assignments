...
function extractNameFromTemplate(value) {
    let finalString = value.replace(/Hello, /g, '');
...
function getRectangleString(width, height) {
    let up='',bot='',middle='',obj1='─',obj2=' ',obj3='│';
    if(width<2 || height<2){
        return false;
    }

    up = '┌'+obj1.repeat(width-2)+'┐'+'\n';
    middle = obj3+obj2.repeat(width-2)+obj3+'\n';
    bot = '└'+obj1.repeat(width-2)+'┘'+'\n';
    return up+middle.repeat(height-2)+bot;
}
